...
const Experience = ({ CompanyLink="", Company, JobTitle, Content, Date, tags=[] }:any) => {
  return (
    ...
    <div className="flex flex-col sm:flex-row my-4 mb-4 group relative">
      <div className="absolute -inset-x-4 -inset-y-2 z-0 rounded-md transition duration-300 motion-reduce:transition-none lg:-inset-x-6 group-hover:bg-slate-800/50 "></div>
